...
const productSold = "cameras" // Pour adapter le MVP à d'autres produits facilement
const APIURL = "http://localhost:3000/api/" + productSold + "/";
...
function getProducts() {
	fetch(APIURL)
		...
		.catch(function(err) {
			console.log('Erreur fetch :-S', err);
		});
}
